...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("restorder.orderproduk"))
...
//                .select()
//                .apis(RequestHandlerSelectors.basePackage("com.yourpackage")) // Sesuaikan dengan package controller Anda
...
//
//    private ApiInfo apiEndPointsInfo() {
//        return new ApiInfoBuilder().title("RESTFul API BACKEND SERVICE")
//                .description("Backend Service Test Magang PLN Icon Plus")
//                .contact(new Contact("Ilham Mufid", "github.com/mufidbrown", "mufiddev@gmail.com"))
//                .license("Apache 2.0")
//                .licenseUrl("http://www.apache.org/licenses/LICENSE-2.0.html")
//                .version("1.12.3")
